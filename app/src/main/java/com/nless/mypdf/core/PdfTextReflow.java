 ...
 */
public final class PdfTextReflow {
    ...
    public static String reflowPage(PdfTextPage page) {
        if (page == null || page.glyphs.isEmpty()) return "";
        return reflowSelection(page, 0, page.glyphs.size() - 1);
    }

    public static String reflowSelection(PdfTextPage page, int selectionStart, int selectionEnd) {
        if (page == null || page.glyphs.isEmpty()) return "";
    ...
    public static String reflowOcrPage(OcrPageResult result) {
